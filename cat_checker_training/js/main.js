...
class DefaultWeb {
    ...
    async firstFrase() {
        ...
        this.tts_action.sendGoal({
            rawtext: {
                text: "<mark name='doTrick trickName=bow'/> You may now practice the activity until you feel comfortable with it. <mark name='doTrick trickName=show_left'/> Let me know once you are ready to start the official trial.", 
                lang_id: "en_GB"
            }
        }, (response) => {

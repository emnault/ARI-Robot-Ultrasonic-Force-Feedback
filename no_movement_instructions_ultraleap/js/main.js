...
class DefaultWeb {
    ...
    async firstFrase() {
        ...
        this.tts_action.sendGoal({
            rawtext: {
                text: "You can control the green cursor by hovering your hand approximately 20 centimeters over the ultrasonic feedback device. The aim is to select the category from the top row that corresponds to the image at the bottom of the screen. Select a category by holding the cursor over a category for one second. If you get it wrong, you can try again. The goal is to complete the task both quickly and accurately.", 
                lang_id: "en_GB"
            }
        }, (response) => {
